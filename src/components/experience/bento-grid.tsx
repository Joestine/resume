...
export const BentoGrid = ({ className, children }: { className?: string; children?: React.ReactNode }) => {
	return (
		<div className={cn("grid md:auto-rows-[16rem] grid-cols-1 md:grid-cols-4 gap-4 max-w-8xl mx-auto", className)}>
			{children}
		</div>
	);
};
	...
	return (
		<div
			...
			<div className="group-hover/bento:translate-x-2 transition duration-200">
				...
				<div className="font-sans font-normal text-neutral-300">{description}</div>
			</div>
		</div>
	);
};
